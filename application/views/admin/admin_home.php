...
<div class="wrap">
	<div id="header">
		<div id="top">
			<div class="left">
				<p>Welcome, <strong>PaweÅ‚ B.</strong> [ <a href="">logout</a> ]</p>
			</div>
			<div class="right">
				...
				<li class="upp"><a href="#">Settings</a>
					<ul>
						...
						<li>&#8250; <a href="">Contact Form</a></li>
                                ...
                                <li class="upp"><a href="<?php echo base_url();?>super_admin/add_category">Add Category</a>
	...
	<div id="footer">
		<div class="left">
			<p>Design: <a href="http://kilab.pl">PaweÅ‚ Balicki</a> | Admin Panel: <a href="">YourSite.com</a></p>
		</div>
		<div class="right">
