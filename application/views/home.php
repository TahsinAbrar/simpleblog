...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <body>
        <div id="menu">
            <ul>
                <li><a href="<?php echo base_url();?>welcome/index.jsp" accesskey="1" title="">Blog</a></li>
                <!--<li class="active"><a href="<?php //echo base_url();?>welcome/gallery.jsp" accesskey="2" title="">Photos</a></li>-->
                ...
                <li><a href="<?php echo base_url();?>blogger/my_blogs" accesskey="4" title="">My Blogs</a></li>
                <li><a href="<?php echo base_url();?>blogger/logout" accesskey="4" title="">Logout</a></li>
                <?php
                    }
                    else{
                ?>
                ...
                <li><a href="<?php echo base_url()?>login/user_login" accesskey="4" title="">Login</a></li>
                <?php } ?>
            </ul>
        </div>
        <!-- end #menu -->
                ...
                <div id="links">
                    <ul>
                        ...
                        <li>
                            <h2>Archives</h2>
                            <ul>
                                <li><a href="#">March 2007</a> <i>(22)</i></li>
